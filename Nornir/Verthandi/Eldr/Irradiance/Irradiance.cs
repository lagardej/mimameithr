...
using Nornir.Verthandi.Geimr.BodyRotation;
using Nornir.Verthandi.Geimr.Orbit;
using Nornir.Verthandi.Geimr.StellarLuminosity;
using UnitsNet;

namespace Nornir.Verthandi.Eldr.Irradiance;
