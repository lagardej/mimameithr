...
///     (<see cref="Geimr.Geometry.CellGridSystem" />) is domain-agnostic and doesn't know about Eldr's
///     per-cell data, so provisioning happens here instead. Purely structural — actual insolation values
///     are written every tick by <see cref="IrradianceSystem" />, which requires the component to already
...
/// </remarks>
public sealed class IrradianceProvisionSystem : QuerySystem<CellIdentityC, CellParentRefC>
{
    /// <inheritdoc />
